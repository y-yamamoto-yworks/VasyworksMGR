...
from masters.forms import InsuranceCompanyForm


class InsuranceCompanyView(UpdateView):
    """
    火災保険会社
    """
    ...
    def dispatch(self, *args, **kwargs):
        ...
        try:
            ...
            if idb64.isdecimal():
                insurance_company_id = xint(idb64)
        except ValueError:
            raise Http404

        self.insurance_company = get_object_or_404(InsuranceCompany, pk=insurance_company_id)

        self.kwargs['pk'] = insurance_company_id
