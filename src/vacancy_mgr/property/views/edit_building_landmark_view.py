...
from property.forms import EditBuildingLandmarkForm
from property.models import Building, BuildingLandmark


class EditBuildingLandmarkView(UpdateView):
    """
    建物ランドマーク編集
    """
    model = BuildingLandmark
    form_class = EditBuildingLandmarkForm
    template_name = 'property/edit_building_landmark.html'
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        id = kwargs['id']
        self.building_landmark = get_object_or_404(BuildingLandmark, pk=id, building=building)

        self.kwargs['pk'] = self.building_landmark.pk
    ...
    def get_context_data(self, **kwargs):
        ...
        context['data'] = self.building_landmark
        return context
    ...
    def get_success_url(self):
        ...
        if self.building_landmark:
            if self.back_url:
                ...
                url = reverse_lazy('property_building', kwargs={'oid': self.building_landmark.building.oid})
