...
from property.forms import EditBuildingMovieForm
from property.models import Building, BuildingMovie


class EditBuildingMovieView(UpdateView):
    """
    建物動画編集
    """
    model = BuildingMovie
    form_class = EditBuildingMovieForm
    template_name = 'property/edit_building_movie.html'
