...
class DeleteRoomVacancyThemeView(FormView):
    """
    部屋空室テーマ削除
    """
    model = RoomVacancyTheme
    form_class = DeleteForm
    template_name = 'property/delete_room_vacancy_theme.html'
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        id = kwargs['id']
        self.room_vacancy_theme = get_object_or_404(RoomVacancyTheme, pk=id, room=room)

        self.kwargs['pk'] = self.room_vacancy_theme.pk
    ...
    def get_context_data(self, **kwargs):
        ...
        context['data'] = self.room_vacancy_theme
        return context
    ...
    def get_success_url(self):
        ...
        if self.room_vacancy_theme:
            if self.back_url:
                ...
                url = reverse_lazy('property_room', kwargs={'oid': self.room_vacancy_theme.room.oid})
