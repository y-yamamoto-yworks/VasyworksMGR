...
from property.forms import EditBuildingGarageForm
from property.models import Building, BuildingGarage


class EditBuildingGarageView(UpdateView):
    """
    建物ガレージ編集
    """
    model = BuildingGarage
    form_class = EditBuildingGarageForm
    template_name = 'property/edit_building_garage.html'
