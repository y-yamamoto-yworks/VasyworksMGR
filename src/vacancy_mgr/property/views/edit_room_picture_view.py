...
from property.forms import EditRoomPictureForm
from property.models import Room, RoomPicture


class EditRoomPictureView(UpdateView):
    """
    部屋画像編集
    """
    model = RoomPicture
    form_class = EditRoomPictureForm
    template_name = 'property/edit_room_picture.html'
