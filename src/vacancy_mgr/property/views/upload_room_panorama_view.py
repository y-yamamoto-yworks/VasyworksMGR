...
from property.forms import UploadRoomPanoramaForm
from property.models import Room, RoomPanorama
from enums.models import PanoramaType


class UploadRoomPanoramaView(FormView):
    """
    部屋パノラマアップロード
    """
        ...
        if settings.DEMO:
            ...
            if self.room:
                ...
                if self.request.FILES['panorama']:
                    ...
                    file_path = MediaHelper.get_upload_panorama_path(self.room.building, file_name)
