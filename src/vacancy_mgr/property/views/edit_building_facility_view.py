...
from property.forms import EditBuildingFacilityForm
from property.models import Building, BuildingFacility


class EditBuildingFacilityView(UpdateView):
    """
    建物周辺施設編集
    """
    model = BuildingFacility
    form_class = EditBuildingFacilityForm
    template_name = 'property/edit_building_facility.html'
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        id = kwargs['id']
        self.building_facility = get_object_or_404(BuildingFacility, pk=id, building=building)

        self.kwargs['pk'] = self.building_facility.pk
    ...
    def get_context_data(self, **kwargs):
        ...
        context['data'] = self.building_facility
        return context
    ...
    def get_success_url(self):
        ...
        if self.building_facility:
            if self.back_url:
                ...
                url = reverse_lazy('property_building', kwargs={'oid': self.building_facility.building.oid})
