...
from property.forms import EditBuildingPanoramaForm
from property.models import Building, BuildingPanorama


class EditBuildingPanoramaView(UpdateView):
    """
    建物パノラマ編集
    """
    model = BuildingPanorama
    form_class = EditBuildingPanoramaForm
    template_name = 'property/edit_building_panorama.html'
    success_url = reverse_lazy('menu_index')
    user = None
    back_url = None
    building_panorama = None
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        id = kwargs['id']
        self.building_panorama = get_object_or_404(BuildingPanorama, pk=id, building=building)

        self.kwargs['pk'] = self.building_panorama.pk
    ...
    def get_context_data(self, **kwargs):
        ...
        context['data'] = self.building_panorama
        return context
    ...
    def get_success_url(self):
        ...
        if self.building_panorama:
            if self.back_url:
                ...
                url = reverse_lazy('property_building', kwargs={'oid': self.building_panorama.building.oid})
