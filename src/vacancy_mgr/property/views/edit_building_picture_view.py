...
from property.forms import EditBuildingPictureForm
from property.models import Building, BuildingPicture


class EditBuildingPictureView(UpdateView):
    """
    建物画像編集
    """
    model = BuildingPicture
    form_class = EditBuildingPictureForm
    template_name = 'property/edit_building_picture.html'
