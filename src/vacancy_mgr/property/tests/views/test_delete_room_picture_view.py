...
class DeleteRoomPictureViewTest(TestCase):
    """
    部屋画像削除ビューのテスト
    """
    def setUp(self):
    ...
    def test_get_delete_room_picture_view(self):
        url = reverse(
            'property_delete_room_picture',
            args=[
    ...
    def test_post_delete_room_picture_view(self):
        url = reverse(
            'property_delete_room_picture',
            args=[
                '5073ab83b3204160a947d1ab470a0b2b',     # 表示項目確認用マンション DEMO1号室
