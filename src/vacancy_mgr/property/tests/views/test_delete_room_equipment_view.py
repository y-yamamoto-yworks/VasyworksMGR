...
class DeleteRoomEquipmentViewTest(TestCase):
    """
    部屋設備削除ビューのテスト
    """
    def setUp(self):
    ...
    def test_get_delete_room_equipment_view(self):
        url = reverse(
            'property_delete_room_equipment',
            args=[
    ...
    def test_post_delete_room_equipment_view(self):
        url = reverse(
            'property_delete_room_equipment',
            args=[
                '5073ab83b3204160a947d1ab470a0b2b',     # 表示項目確認用マンション DEMO1号室
