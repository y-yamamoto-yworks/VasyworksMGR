...
class DeleteRoomPanoramaViewTest(TestCase):
    """
    部屋パノラマ削除ビューのテスト
    """
    def setUp(self):
    ...
    def test_get_delete_room_panorama_view(self):
        url = reverse(
            'property_delete_room_panorama',
            args=[
    ...
    def test_post_delete_room_panorama_view(self):
        url = reverse(
            'property_delete_room_panorama',
            args=[
                '5073ab83b3204160a947d1ab470a0b2b',     # 表示項目確認用マンション DEMO1号室
