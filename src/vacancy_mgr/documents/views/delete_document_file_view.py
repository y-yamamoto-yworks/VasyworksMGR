...
class DeleteDocumentFileView(FormView):
    """
    書類ファイル削除
    """
    model = DocumentFile
    form_class = DeleteForm
    template_name = 'documents/delete_document_file.html'
    ...
    def form_valid(self, form):
        if settings.DEMO:
            ...
            self.document_file.is_deleted = True
            self.document_file.updated_at = timezone.datetime.now()
            self.document_file.updated_user = self.user
