...
class DeleteManagementInfoView(FormView):
    """
    管理お知らせ削除
    """
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        self.info = get_object_or_404(ManagementInfo, pk=management_info_id)

        self.kwargs['pk'] = management_info_id
    ...
    def get_success_url(self):
        ...
        if self.info:
            if self.back_url:
                ...
                url = reverse_lazy('info_management_info_list')
