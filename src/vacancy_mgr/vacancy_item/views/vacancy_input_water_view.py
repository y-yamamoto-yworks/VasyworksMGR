...
from vacancy_item.forms import VacancyInputWaterForm


class VacancyInputWaterView(UpdateView):
    """
    空室入力水道
    """
    model = VacancyInputWater
    form_class = VacancyInputWaterForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputWater, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['item_name'] = '水道入力テキスト'
        context['action_url'] = '/vacancy_item/input_water/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_water', kwargs={'idb64': self.item.idb64})
