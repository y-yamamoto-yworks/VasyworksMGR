...
from vacancy_item.forms import VacancyInputPaymentForm


class VacancyInputPaymentView(UpdateView):
    """
    空室入力賃料支払
    """
    model = VacancyInputPayment
    form_class = VacancyInputPaymentForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputPayment, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_payment/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_payment', kwargs={'idb64': self.item.idb64})
