...
from vacancy_item.forms import VacancyInputCancelNoticeForm


class VacancyInputCancelNoticeView(UpdateView):
    """
    空室入力解約通知
    """
    model = VacancyInputCancelNotice
    form_class = VacancyInputCancelNoticeForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputCancelNotice, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_cancel_notice/'
        return context
