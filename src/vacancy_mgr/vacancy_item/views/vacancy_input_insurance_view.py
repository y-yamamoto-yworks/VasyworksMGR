...
from vacancy_item.forms import VacancyInputInsuranceForm


class VacancyInputInsuranceView(UpdateView):
    """
    空室入力火災保険
    """
    model = VacancyInputInsurance
    form_class = VacancyInputInsuranceForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputInsurance, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_insurance/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_insurance', kwargs={'idb64': self.item.idb64})
