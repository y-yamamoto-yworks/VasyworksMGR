...
from vacancy_item.forms import VacancyInputChangeLockForm


class VacancyInputChangeLockView(UpdateView):
    """
    空室入力鍵交換
    """
    model = VacancyInputChangeLock
    form_class = VacancyInputChangeLockForm
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_change_lock/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_change_lock', kwargs={'idb64': self.item.idb64})
