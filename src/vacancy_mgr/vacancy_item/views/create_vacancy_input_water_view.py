...
class CreateVacancyInputWaterView(FormView):
    """
    空室入力水道作成
    """
    ...
    def get_success_url(self):
        ...
        if self.vacancy_input_item:
            url = reverse_lazy('vacancy_item_vacancy_input_water', kwargs={'idb64': self.vacancy_input_item.idb64})
            back_url = xstr(reverse_lazy('vacancy_item_vacancy_input_water_list'))
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/create_input_water/'
        return context
