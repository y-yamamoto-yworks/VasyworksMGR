...
from vacancy_item.forms import VacancyInputPortalForm


class VacancyInputPortalView(UpdateView):
    """
    空室入力ポータル掲載
    """
    model = VacancyInputPortal
    form_class = VacancyInputPortalForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputPortal, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_portal/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_portal', kwargs={'idb64': self.item.idb64})
