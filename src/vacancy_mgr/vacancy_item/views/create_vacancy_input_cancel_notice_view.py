...
class CreateVacancyInputCancelNoticeView(FormView):
    """
    空室入力解約通知作成
    """
    form_class = CreateWithTextForm
    template_name = 'vacancy_item/create_vacancy_input.html'
    success_url = reverse_lazy('vacancy_item_vacancy_input_cancel_notice_list')
    ...
    def get_success_url(self):
        ...
        if self.vacancy_input_item:
            url = reverse_lazy('vacancy_item_vacancy_input_cancel_notice', kwargs={'idb64': self.vacancy_input_item.idb64})
            back_url = xstr(reverse_lazy('vacancy_item_vacancy_input_cancel_notice_list'))
    ...
    def get_context_data(self, **kwargs):
        ...
        context['item_name'] = '解約通知入力テキスト'
        context['action_url'] = '/vacancy_item/create_input_cancel_notice/'
        return context
