...
from vacancy_item.forms import VacancyInputDocumentPriceForm


class VacancyInputDocumentPriceView(UpdateView):
    """
    空室入力書類代
    """
    model = VacancyInputDocumentPrice
    form_class = VacancyInputDocumentPriceForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputDocumentPrice, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_document_price/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_document_price', kwargs={'idb64': self.item.idb64})
