...
class CreateVacancyInputGuaranteeView(FormView):
    """
    空室入力保証会社作成
    """
    form_class = CreateWithTextForm
    template_name = 'vacancy_item/create_vacancy_input.html'
    success_url = reverse_lazy('vacancy_item_vacancy_input_guarantee_list')
    ...
    def get_success_url(self):
        ...
        if self.vacancy_input_item:
            url = reverse_lazy('vacancy_item_vacancy_input_guarantee', kwargs={'idb64': self.vacancy_input_item.idb64})
            back_url = xstr(reverse_lazy('vacancy_item_vacancy_input_guarantee_list'))
    ...
    def get_context_data(self, **kwargs):
        ...
        context['item_name'] = '保証会社入力テキスト'
        context['action_url'] = '/vacancy_item/create_input_guarantee/'
        return context
