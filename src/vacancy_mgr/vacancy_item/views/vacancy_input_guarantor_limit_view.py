...
from vacancy_item.forms import VacancyInputGuarantorLimitForm


class VacancyInputGuarantorLimitView(UpdateView):
    """
    空室入力保証人極度額
    """
    model = VacancyInputGuarantorLimit
    form_class = VacancyInputGuarantorLimitForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputGuarantorLimit, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_guarantor_limit/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_guarantor_limit', kwargs={'idb64': self.item.idb64})
