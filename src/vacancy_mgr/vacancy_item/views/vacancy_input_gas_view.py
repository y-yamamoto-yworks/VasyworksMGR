...
from vacancy_item.forms import VacancyInputGasForm


class VacancyInputGasView(UpdateView):
    """
    空室入力ガス
    """
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputGas, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_gas/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_gas', kwargs={'idb64': self.item.idb64})
