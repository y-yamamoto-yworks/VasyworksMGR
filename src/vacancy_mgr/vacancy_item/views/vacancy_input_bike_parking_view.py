...
from vacancy_item.forms import VacancyInputBikeParkingForm


class VacancyInputBikeParkingView(UpdateView):
    """
    空室入力駐輪場
    """
    model = VacancyInputBikeParking
    form_class = VacancyInputBikeParkingForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputBikeParking, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_bike_parking/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_bike_parking', kwargs={'idb64': self.item.idb64})
