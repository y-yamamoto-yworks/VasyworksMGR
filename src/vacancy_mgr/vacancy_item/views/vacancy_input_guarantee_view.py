...
from vacancy_item.forms import VacancyInputGuaranteeForm


class VacancyInputGuaranteeView(UpdateView):
    """
    空室入力保証会社
    """
    model = VacancyInputGuarantee
    form_class = VacancyInputGuaranteeForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputGuarantee, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_guarantee/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_guarantee', kwargs={'idb64': self.item.idb64})
