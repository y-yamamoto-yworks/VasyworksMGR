...
from vacancy_item.forms import VacancyInputGarageForm


class VacancyInputGarageView(UpdateView):
    """
    空室入力駐車場
    """
    model = VacancyInputGarage
    form_class = VacancyInputGarageForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputGarage, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_garage/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_garage', kwargs={'idb64': self.item.idb64})
