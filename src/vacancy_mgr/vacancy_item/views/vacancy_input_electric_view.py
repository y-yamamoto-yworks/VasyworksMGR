...
from vacancy_item.forms import VacancyInputElectricForm


class VacancyInputElectricView(UpdateView):
    """
    空室入力電気
    """
    model = VacancyInputElectric
    form_class = VacancyInputElectricForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputElectric, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_electric/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_electric', kwargs={'idb64': self.item.idb64})
