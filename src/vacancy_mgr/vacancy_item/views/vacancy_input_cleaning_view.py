...
from vacancy_item.forms import VacancyInputCleaningForm


class VacancyInputCleaningView(UpdateView):
    """
    空室入力退去時清掃
    """
    model = VacancyInputCleaning
    form_class = VacancyInputCleaningForm
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputCleaning, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_cleaning/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_cleaning', kwargs={'idb64': self.item.idb64})
