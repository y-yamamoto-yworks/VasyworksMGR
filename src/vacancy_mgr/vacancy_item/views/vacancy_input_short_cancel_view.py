...
from vacancy_item.forms import VacancyInputShortCancelForm


class VacancyInputShortCancelView(UpdateView):
    """
    空室入力
    """
    ...
    def dispatch(self, *args, **kwargs):
        ...
        self.item = get_object_or_404(VacancyInputShortCancel, pk=item_id)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['action_url'] = '/vacancy_item/input_short_cancel/'
        return context
    ...
    def get_success_url(self):
        url = reverse_lazy('vacancy_item_vacancy_input_short_cancel', kwargs={'idb64': self.item.idb64})
